...
This is not part of the build. Run it by hand when include/inkcell/ui/icons.def changes and commit
...
The icons and their glyph names come from include/inkcell/ui/icons.def, which is also what builds
