 ...
 *
 * inkcell_fb_widgets_list.c owns the window - where a row lands, whether it stands on a card, what the
 * cursor is on - and inkcell_fb_widgets_item.c draws into it. Everything here would still be `static`
 ...
 *
 * Not public API, and not part of inkcell_fb_widgets.h: nothing outside these two files should include
 * it.
 */
 ...
 * does a card heading over rows that carry them. See inkcell_fb_widgets_list.c for what it measures and
