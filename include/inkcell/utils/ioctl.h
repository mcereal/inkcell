#ifndef INKCELL_IOCTL_H
#define INKCELL_IOCTL_H
...
typedef unsigned long inkcell_ioctl_request;
#else
typedef int inkcell_ioctl_request;
#endif
 ...
 */
static inline inkcell_ioctl_request inkcell_ioctl_request_of(unsigned long request) {
    return (inkcell_ioctl_request)request;
}

#endif /* INKCELL_IOCTL_H */
