#ifndef INKCELL_ENV_H
#define INKCELL_ENV_H
 ...
 *
 * Every name below is a *suffix*: inkcell reads "THEME" as "<PREFIX>_THEME", so the library's
...
/*
 * The prefix, without its underscore. "INKCELL" until an application says otherwise, which it
