...
#define INKCELL_FONT_UI_CELL_W 5
...
#define INKCELL_FONT_UI_MASTER_W (INKCELL_FONT_UI_CELL_W * 4)
#define INKCELL_FONT_UI_MASTER_TOP (INKCELL_FONT_UI_OVERHANG * 4)
#define INKCELL_FONT_UI_MASTER_H ((INKCELL_FONT_UI_CELL_H + INKCELL_FONT_UI_OVERHANG) * 4)
