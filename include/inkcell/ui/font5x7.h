#ifndef INKCELL_FONT5X7_H
#define INKCELL_FONT5X7_H
...
#define INKCELL_FONT_WIDTH 5
#define INKCELL_FONT_HEIGHT 7
...
struct inkcell_font_glyph {
    ...
    uint8_t above[INKCELL_FONT_WIDTH];
};
...
/* This font as a `struct inkcell_font`, which is how a theme reaches it. Everything that draws
